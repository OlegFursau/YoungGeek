...
class BlockTaskEnglish extends Component {
        ...
        return new Promise(resolve => {
            ...
            <div id="mainEnglish">
                <div class="english">
                    ...
                    <img src=${arrDb[firstWord].picture} alt="">"
                        <div class="english__voice">
                            ...
                            ${arrDb[firstWord].word}
                            </h2>
                        </div>
                        <div class="english__block-translater">
                            <h3>${arrDb[firstWord].translater}</h3>
                        </div>
                    </div>
            
                    <div class="english__blocks" id="2">
                    <img src=${arrDb[secondWord].picture} alt="">"
                        <div class="english__voice">
                            ...
                            ${arrDb[secondWord].word}
                            </h2>
                        </div>
                        <div class="english__block-translater">
                            <h3>${arrDb[secondWord].translater}</h3>
                        </div>
                    </div>
                
                    <div class="english__blocks" id="3">
                    <img src=${arrDb[threeWord].picture} alt="">"
                        <div class="english__voice">
                            ...
                            ${arrDb[threeWord].word}
                            </h2>
                        </div>
                        <div class="english__block-translater">
                            <h3>${arrDb[threeWord].translater}</h3>
                        </div>
                    </div>
            
                    <div class="english__blocks" id="4">
                    <img src=${arrDb[fourWord].picture} alt="">"
                        <div class="english__voice">
                        ...
                        <div class="english__block-translater">
                            <h3>${arrDb[fourWord].translater}</h3>
                        </div>
                    </div>
                </div>
    ...
    renderFinishPage() {
        ...
        const phrase = document.getElementsByClassName('text')[0];
